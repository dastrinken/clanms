...
<form action="./dashboard.php" method="post">
    ...
    <div class="d-flex mb-3">
        ...
        <div class="input-group w-auto me-2">
            ...
            <input class="form-control" type="datetime-local" name="date_start" value="<?php echo empty($date_start) ? date('Y-m-d H:i:s') : $date_start; ?>" aria-describedby="ariaLabelPublish">
        </div>
        <div class="input-group w-auto me-2">
            <span class="input-group-text" id="ariaLabelPublish">Event Ende</span>
            <input class="form-control" type="datetime-local" name="date_end" value="<?php echo empty($date_end) ? date('Y-m-d H:i:s') : $date_end; ?>" aria-describedby="ariaLabelPublish">
        </div>
        <select name="eventCat" class="form-select" aria-label="select event category">
