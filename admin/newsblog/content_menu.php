    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="displayArticlesDropdown">
                <li><a id="thisWeeksArticles" class="dropdown-item" href="#" onclick="page = 1; getTableView(saveFolder, saveFile, 'all'); return false;">Alle Artikel</a></li>
                ...
                <li><a id="articlesComments" class="dropdown-item" href="#" onclick="page = 1; getTableView(saveFolder, saveFile, 'commented'); return false;">Kommentare</a></li>
            </ul>
        </div>
    </div>
</div>