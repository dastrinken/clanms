<div class="row">
    <div class="col m-3 rounded border border-white p-0 ">
        <img src="./content/about_us/pexels-yan-krukov-9072394.jpg" class="w-100 rounded " alt="logo">
    </div>

    <div class="col m-3 d-flex align-items-center"> 
        <h3 class="text-center">eine wunderschöne geschischte über unsere Grupee.</h3> 
    </div>
</div>
